...
import { MealsTable } from "@/components/pages/meals/meals-table";
...
export const Route = createFileRoute("/_protected/meals/")({
  ...
  loader: ({ context }) =>
    context.queryClient.ensureQueryData(mealsQueryOptions()),
  pendingComponent: () => (
    <Loader variant="full-screen" label="جاري تحميل الوجبات..." />
  ),
});

function RouteComponent() {
  const { data: mealsResponse } = useSuspenseQuery(mealsQueryOptions());
